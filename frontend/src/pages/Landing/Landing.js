  ...
  return (
    <div>
      <div class="box has-background-light">
        ...
        <div class="columns">
          <div class="column">
            <p class="is-size-3" style={{ textAlign: "center" }}>
              Gameduc
            </p>
          </div>
        </div>
        ...
        <div class="columns" style={{ backgroundColor: "#eeeeee" }}>
          <p class="is-size-5 column  is-three-quarters">
            ...
            <br />
            <p class="is-size-6">
              Gameduc é uma plataforma para professores e alunos, em que alunos
              irão pontuar para competir e contabilizar seu pontos durante o
              decorrer do jogo criado pelo jogo.
            </p>
          </p>
          <div class="column">
        ...
        <div class="columns" style={{ backgroundColor: "#ffffff" }}>
          ...
          <p class="is-size-5 column">
            ...
            <p class="is-size-6">
              ...
              cadastrar jogos em cada disciplina de acordo com a necessidade.
              <br /> Cada jogo tem suas regras definidas pelo professor como
              pontuação, tempo para completar e requisitos.
              <br /> O educador também deve aceitar ou não os jogos realizados
              pelos alunos, concedendo a pontuação.
            </p>
            <br />
            <p class="is-size-6">
              Aluno: Acessa suas disciplinas e os jogos de cada uma. Pode marcar
              como completo nos jogos disponibilizados pelo professor e
              acompanhar seu progresso em cada matéria e em um ranking geral.{" "}
            </p>
          </p>
        </div>
        ...
        <div class="columns" style={{ backgroundColor: "#eeeeee" }}>
          <p class="column is-size-5 is-three-quarters">
            ...
            <p class="is-size-6">
              ...
              atividades, e todos os critérios são definidos de acordo com o
              educador.
              <br />
              Pode ser a entrega de um papel, completar um projeto ou plantar
              uma árvore. Qualquer atividade que o educador definir e
              classificar nos jogos vale.
            </p>
          </p>
          <div class="column">
            <figure class="image has-image-centered is-128x128">
